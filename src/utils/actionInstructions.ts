// src/utils/actionInstructions.ts
// Step-by-step instructions for each bottleneck/action type
// Keys must match bottleneck IDs from computeAssessment.ts
...
type ActionInstructionsMap = Record<string, ActionInstruction>;

export const ACTION_INSTRUCTIONS: ActionInstructionsMap = {
  // ============================================
  // PROPERTY CLAIMS
  // ============================================
  free_car_wash: {
