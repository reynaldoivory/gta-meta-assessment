// src/utils/detectBottlenecks/assetGaps.ts
// TIER 3: ASSET GAPS

import { MODEL_CONFIG } from '../modelConfig.js';
import type { DetectionParams, Bottleneck } from '../bottleneckTypes';

/**
 * Detect income diversification gaps
 */
...
/**
 * Detect asset gaps (TIER 3)
 */
export const detectAssetGaps = (
